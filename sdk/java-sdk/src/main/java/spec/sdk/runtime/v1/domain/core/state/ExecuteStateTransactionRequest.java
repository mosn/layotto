...
public class ExecuteStateTransactionRequest {
     ...
     */
    private List<spec.sdk.runtime.v1.domain.core.state.TransactionalStateOperation<?>> operations;
    ...
    public ExecuteStateTransactionRequest setOperations(List<spec.sdk.runtime.v1.domain.core.state.TransactionalStateOperation<?>> operations) {
