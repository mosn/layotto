...
import (
	...
	"github.com/layotto/L8-components/pkg/common"
)
...
func init() {
	indicators := &actuators.ComponentsIndicator{ReadinessIndicator: newHealthIndicator(), LivenessIndicator: newHealthIndicator()}
