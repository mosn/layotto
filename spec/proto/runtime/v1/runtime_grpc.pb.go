...
type RuntimeClient interface {
	...
	// Note: grpc gateway doesn't support path parameter with client streaming
	//       So we are not adding store name in the restful endpoints like
	//       /v1.0/file/{store_name}/put
