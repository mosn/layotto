...
type ListObjectsInput struct {
	...
	FetchOwner string `protobuf:"bytes,10,opt,name=fetch_owner,json=fetchOwner,proto3" json:"fetch_owner,omitempty"`
}
...
func (x *ListObjectsInput) GetFetchOwner() string {
	if x != nil {
		return x.FetchOwner
	}
	return ""
...
var file_oss_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x66, 0x65, 0x74, 0x63, 0x68, 0x4f, 0x77, 0x6e,
