...
func (m *MockZKConnection) NewConnection(expire time.Duration, meta metadata) (ZKConnection, error) {
	m.ctrl.T.Helper()
...
func (mr *MockZKConnectionMockRecorder) NewConnection(expire, meta interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewConnection", reflect.TypeOf((*MockZKConnection)(nil).NewConnection), expire, meta)
}
