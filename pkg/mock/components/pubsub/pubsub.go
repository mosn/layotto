...
func (m *MockPubSub) Publish(arg0 context.Context, arg1 *pubsub.PublishRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockPubSub) Subscribe(arg0 context.Context, arg1 pubsub.SubscribeRequest, arg2 pubsub.Handler) error {
	m.ctrl.T.Helper()
...
func (mr *MockPubSubMockRecorder) Subscribe(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subscribe", reflect.TypeOf((*MockPubSub)(nil).Subscribe), arg0, arg1, arg2)
}
