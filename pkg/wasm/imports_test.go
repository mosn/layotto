...
func TestGetState(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		grpc.LayottoAPISingleton = grpc.NewAPI("", nil, nil, nil, nil, map[string]state.Store{"mock": mockStore}, nil, nil, nil, nil)
...
func TestInvokeService(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		grpc.LayottoAPISingleton = grpc.NewAPI("", nil, nil, map[string]rpc.Invoker{mosninvoker.Name: mockInvoker}, nil, nil, nil, nil, nil, nil)
