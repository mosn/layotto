...
func main() {
	...
	metaData["token"] = "123"
<<<<<<< HEAD
	req := &runtimev1pb.InvokeBindingRequest{Name: "http", Operation: "get", Metadata: metaData, Data: []byte("auth data")}
=======
	req := &runtimev1pb.InvokeBindingRequest{Name: "hello", Operation: "get", Metadata: metaData, Data: []byte("auth data")}
>>>>>>> upstream/main
