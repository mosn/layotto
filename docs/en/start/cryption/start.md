...
This example shows how to invoke Layotto CryptionService API.

## What is CryptionService API used for?
...
## step 2. Run the client program to invoke Layotto CryptionService API
<!-- tabs:start -->
### **Go**
...
The demo client program uses the SDK provided by Layotto to invoke the Layotto CryptionService API.
